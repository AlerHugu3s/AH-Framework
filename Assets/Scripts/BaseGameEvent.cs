...
public class GameEventDispatcher
{
    ...
    public void AddEventListener(BaseGameEvent.GameEventType type, GameEventListenerDelegate listener)
    {
    ...
    public void RemoveEventListener(BaseGameEvent.GameEventType type, GameEventListenerDelegate listener)
    {
